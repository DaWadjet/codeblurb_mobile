...
import 'package:codeblurb_mobile/pages/explore/explore_course_item.dart';
import 'package:codeblurb_mobile/pages/explore/explore_provider.dart';
...
class ExplorePage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final filter = useState(filterProps ?? SortBy.none());
      ...
      body: Stack(
        children: [
          AdaptivePullToRefresh(
            onRefresh: () => ref
                .watch(exploreNotifierProvider.notifier)
                .onRefresh(pageProps),
            child: Padding(
